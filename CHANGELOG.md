...
- **Dejar la cuota en cero pide confirmación explícita**, la misma puerta que la migración `0025` le puso a un cargo sobre *una* unidad, ahora en la escritura que multiplica por **todas**. Con el aviso de que de cero no se sale con un porcentaje.
